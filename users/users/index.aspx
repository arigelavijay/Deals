...
<head>
    <meta charset="utf-8">
    <title>RxShopy</title>
   <link href="Images/favicon-new.ico" rel="icon" type="image/x-icon" />
...
<body class="main-container body-blue" ng-app="myApp" id="bodyId">
    ...
    <script src="Scripts/js/Controllers/LocationCntrl.js"></script>
    ...
    <script src="Scripts/js/Services/LocationService.js"></script>
