 ...
 */
angular.module('timepickerPop', ['ui.bootstrap']).factory('timepickerState', function () {
    var pickers = [];
    return {
...
app.directive("timeFormat", function ($filter) {
    return {
        restrict: 'A',
        require: 'ngModel',
        scope: {
...
app.directive('timepickerPop', function ($document, timepickerState) {
    return {
        restrict: 'E',
        transclude: false,
        scope: {
